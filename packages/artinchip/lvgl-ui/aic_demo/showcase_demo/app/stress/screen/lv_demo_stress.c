...
#define LV_AIC_USE_DEMO_STRESS 1
#if LV_AIC_USE_DEMO_STRESS
...
static void stress_ui_cb(lv_event_t * e);

static lv_obj_t *ui_stress;
...
lv_obj_t *lv_demo_stress(void)
{
    ui_stress = lv_obj_create(NULL);
    LV_LOG_USER("Starting stress test. (< 100 bytes permanent memory leak is normal due to fragmentation)");
    lv_obj_add_event_cb(ui_stress, stress_ui_cb, LV_EVENT_ALL, NULL);
    timer = lv_timer_create(obj_test_task_cb, LV_DEMO_STRESS_TIME_STEP, NULL);
    state = -1;
    return ui_stress;
}
...
static void obj_test_task_cb(lv_timer_t * tmr)
{
    ...
    switch(state) {
        ...
        case 0:
            ...
            main_page = lv_obj_create(ui_stress);
        ...
        case 1: {
                obj = lv_tabview_create(ui_stress, LV_DIR_TOP, 50);
        ...
        case 3:
            ta = lv_textarea_create(ui_stress);
        ...
        case 4:
            ...
            lv_obj_set_style_bg_img_src(obj, LV_SYMBOL_LEFT, 0);
            lv_obj_set_style_bg_img_opa(obj, LV_OPA_50, 0);
        ...
        case 8:
            obj = lv_win_create(ui_stress, 50);
            lv_obj_set_size(obj, LV_HOR_RES / 2, LV_VER_RES / 2);
            lv_obj_align(obj, LV_ALIGN_BOTTOM_RIGHT, 0, 0);
        ...
        case 9:
            ...
            break;
        case 10:
            obj = lv_keyboard_create(ui_stress);
        ...
        case 14:
            obj = lv_msgbox_create(ui_stress, "Title", "Some text on the message box with average length", mbox_btns, true);
        ...
        case 16: {
                lv_obj_t * tv = lv_tileview_create(ui_stress);
            ...
            break;
        case 17: {
                lv_obj_t *kb = lv_keyboard_create(ui_stress);
                lv_obj_t *ta_a = lv_textarea_create(ui_stress);
                lv_obj_align(ta_a, LV_ALIGN_TOP_LEFT, 10, 10);
                lv_textarea_set_placeholder_text(ta_a, "Hello");
                lv_obj_set_size(ta_a, 140, 80);
                auto_del(kb, LV_DEMO_STRESS_TIME_STEP * 1 + 22);
            }
            break;
        case 18:
