...
#define DEFAULT_FONT_COLOR lv_theme_get_color_emphasize(NULL)
...
lv_obj_t *cookbook_comp_create(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_bg_opa(cookbook, LV_OPA_100, 0);
    lv_obj_set_style_bg_color(cookbook, lv_theme_get_color_primary(NULL), 0);
...
static void cookbook_ingredients_create(lv_obj_t *obj, cookbook_data_t *data)
{
    ...
    lv_img_set_src(ingredients_title, LVGL_PATH(cookbook/main_supporting_img.png));
...
static void cookbook_cooking_steps_create(lv_obj_t *obj, cookbook_data_t *data)
{
    ...
    lv_img_set_src(cook_steps_title, LVGL_PATH(cookbook/cooking_steps.png));
                                               ...
                                               lv_coord_t *col_dsc, lv_coord_t *row_dsc)
{
    ...
    for (i = 0; i < ingredient_num; i++) {
        ...
        lv_obj_set_style_bg_color(container, lv_theme_get_color_secondary(NULL), 0);
