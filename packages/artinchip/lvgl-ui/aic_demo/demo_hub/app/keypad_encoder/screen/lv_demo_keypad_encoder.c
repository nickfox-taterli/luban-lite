...
#define LV_AIC_USE_DEMO_KEYPAD_AND_ENCODER 1

#if LV_AIC_USE_DEMO_KEYPAD_AND_ENCODER

static void selectors_create(lv_obj_t * parent);
static void text_input_create(lv_obj_t * parent);
static void msgbox_create(lv_obj_t * parent);

static void msgbox_event_cb(lv_event_t * e);
static void ta_event_cb(lv_event_t * e);
static void ui_keypad_encoder_cb(lv_event_t *e);
...
lv_obj_t* lv_demo_keypad_encoder(void)
{
    if (g == NULL) {
        g = lv_group_create();
    ...
    lv_obj_t *ui_key_pad = lv_obj_create(NULL);
    tv = lv_tabview_create(ui_key_pad, LV_DIR_TOP, LV_DPI_DEF / 3);
    ...
    lv_obj_add_event_cb(ui_key_pad, ui_keypad_encoder_cb, LV_EVENT_ALL, NULL);
...
static void msgbox_create(lv_obj_t * parent)
{
    ...
    lv_obj_t * mbox = lv_msgbox_create(parent, "Hi", "Welcome to the keyboard and encoder demo", btns, false);
