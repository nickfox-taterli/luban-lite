...
#define BLE_EATT_LOG_DEBUG(...)       LOG_D(__VA_ARGS__)
#define BLE_EATT_LOG_INFO(...)        LOG_I(__VA_ARGS__)
#define BLE_EATT_LOG_WARN(...)        LOG_W(__VA_ARGS__)
#define BLE_EATT_LOG_ERROR(...)       LOG_E(__VA_ARGS__)
#define BLE_EATT_LOG_CRITICAL(...)    LOG_E(__VA_ARGS__)
#define BLE_EATT_LOG_DISABLED(...)    IGNORE(__VA_ARGS__)
